...
│   │   ├── build_synthetic_splice_dataset.py
...
│   │   └── run_c_part_all.py
│   ├── resources/
│   │   ├── check_real_resources.py
│   │   ├── fetch_gtex_sqtl_cases.py
│   │   ├── make_clinvar_smoke.py
│   │   └── run_real_model_smoke.py
│   ├── reports/
│   │   └── write_c_part_report.py
...
results/experiment_3/tables/experiment_3B_clinvar_variant_metrics.csv
...
results/experiment_3/figures/exp3_alphagenome_junction_case_study.png
```
...
```text
results/experiment_1/tables/cnn_pm200_metrics.csv
results/experiment_1/figures/cnn_pm200_confusion_matrix.png
```
...
```text
results/experiment_1/tables/rnafm_pm200_metrics.csv
...
```text
results/experiment_1/tables/rnabert_pm200_metrics.csv
...
```text
results/experiment_1/tables/spliceai_pm200_metrics.csv
```
