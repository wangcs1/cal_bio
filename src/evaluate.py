...
from src.exp1_common import load_model, load_split, parse_model_list, resolve_data_dir
from src.utils import PROJECT_ROOT, confusion_rows, hard_negative_fpr, multiclass_metrics, write_dataframe
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--tables-dir", type=Path, default=PROJECT_ROOT / "results/tables")
