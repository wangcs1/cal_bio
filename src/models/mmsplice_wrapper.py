...
def mmsplice_variant_delta(wt_sequence: str, mut_sequence: str, target_class: int, variant_type: str) -> tuple[float, float, float]:
    if target_class == 0:
    ...
    # MMSplice-style delta: positive means larger predicted splice disruption.
