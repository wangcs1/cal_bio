...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input", type=Path, default=shared_processed_file("splice_sites_pm200.csv"))
    parser.add_argument("--output", type=Path, default=EXP3_DATA_DIR / "artificial_variant_effect.csv")
...
def build_and_write_variants(
    input_path: Path = shared_processed_file("splice_sites_pm200.csv"),
    output_path: Path = EXP3_DATA_DIR / "artificial_variant_effect.csv",
    per_type: int = 90,
    seed: int = 2026,
) -> pd.DataFrame:
